...
export default function UploadPage() {
  ...
  return (
    <div className="max-w-[800px] mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16 space-y-10">
      {/* Header */}
      <div className="space-y-4 border-b border-border-light pb-8">
        ...
        <p className="text-sm sm:text-base text-text-secondary font-sans leading-relaxed max-w-2xl">
          Contribute battle-tested operational frameworks to the agency repository.
          Uploaded markdown files are frontmatter-normalized, committed to GitHub,
          and automatically deployed live across the library within ~90 seconds via
          Vercel SSG rebuild.
        </p>
      </div>
                ...
                <div className="bg-bg-secondary/60 border border-border-light rounded-card p-4 flex items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <button
                      type="button"
                      onClick={() => fileInputRef.current?.click()}
                      className="text-xs font-sans text-text-secondary hover:text-text-primary underline px-2 py-1"
                    >
                      Replace
                    </button>
                    <button
                      ...
                      className="p-1 rounded text-text-secondary hover:text-red-500 transition-colors"
